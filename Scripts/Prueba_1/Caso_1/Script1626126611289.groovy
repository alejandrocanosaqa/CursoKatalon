...
WebUI.setText(findTestObject('Prueba_1/Page_ToolsQA/input_Full Name_userName'), 'Rodrigo')

nombre = WebUI.getAttribute(findTestObject('Prueba_1/Page_ToolsQA/input_Full Name_userName'), 'value')

print(nombre)

WebUI.setText(findTestObject('Object Repository/Prueba_1/Page_ToolsQA/input_Email_userEmail'), 'rodrigo@gmail.com')
